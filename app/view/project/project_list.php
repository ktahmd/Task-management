                ...
                <?php $myprojects=$_SESSION['projects'];?>
                    <?php foreach ($myprojects as $project): ?>
                        ...
                        <div class="row">
                            ...
                            <div class="container"> <div class="skills html" style="width: <?php echo htmlspecialchars($_SESSION['p'][$project['id']] , ENT_QUOTES, 'UTF-8');?>%;"><?php echo htmlspecialchars($_SESSION['p'][$project['id']] , ENT_QUOTES, 'UTF-8');?>%</div></div>
                            </div>
                            <div class="column-25 ">
                                <div class="row">
                                    <div class="column-50" align="right" >
                                        <button onclick="openModa('editproject<?php echo htmlspecialchars($project['id'], ENT_QUOTES, 'UTF-8') ?>')" class="btn noni">
                                    ...
                                    <div class="column-50" align="center">
                                        <button onclick="openModa('deleteproject<?php echo htmlspecialchars($project['id'], ENT_QUOTES, 'UTF-8') ?>')" class="btn noni" >
