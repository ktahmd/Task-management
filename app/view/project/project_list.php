                            ...
                            <div class="column-25 ">
                                <div class="row">
                                    <div class="column-50" align="right" >
                                        <button onclick="openModa('editproject<?php echo htmlspecialchars($project['id'], ENT_QUOTES, 'UTF-8') ?>')">
                                    ...
                                    <div class="column-50" align="center">
                                        <button onclick="openModa('deleteproject<?php echo htmlspecialchars($project['id'], ENT_QUOTES, 'UTF-8') ?>')">
